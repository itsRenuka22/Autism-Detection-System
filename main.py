...
for quest in questions1:
  ...
  if (a=='Always'):
    ...
    arr.append(1)
a= st.selectbox('Would you describe your child first words as?',('Very Typical', 'Quite Typical', 'Slightly Unusual', 'Very Unusual','Child does not speak'))
st.write('You selected:',a)
if (a=='Very Typical'):
  arr.append(0)
...
a= st.selectbox('Enter child Ethnicity:',("Hispanic","Latino", "Others", "Pacifica", "White European", "Asian", "Black", "Middle Eastern", "Mixed", "South Asian"))
st.write('You selected:',a)
if (a=='Hispanic'):
  arr.append(0)
elif(a == 'Latino'):
